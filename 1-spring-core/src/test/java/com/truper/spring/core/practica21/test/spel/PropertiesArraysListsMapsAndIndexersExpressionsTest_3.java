...
public class PropertiesArraysListsMapsAndIndexersExpressionsTest_3 {
	...
	public void propertiesSpelTest() {
		...
		// definir y obtener el valor de la expresion "birthdate.year + 1900" en el
		...
		// definir y obtener el valor de la expresion "nationality" en el contexto
		// teslaContext
	...
	public void arraysSpelTest() {
		...
		// definir expresion que corresponda con obtener el valor del invento posicion 2
		// de Tesla
	...
	public void listSpelTest() {
		...
		// definir expresion que corresponda con obtener el valor del miembro posicion 2
		...
		// utilizando el contexto society, obtener el nombre del invento posicion 1 del
		// miembro posicion 2, obtener utilizando el nombre de la funcion/metodo
		String inventionName_1 = spelParser.parseExpression("members.get(2).getInventions()[1]")
		...
		// -------------------------------------
		// utilizando el contexto society, obtener el nombre del invento posicion 1
		// del miembro posicion 2, obener utilizando posicion en el arreglo
		String otherInventionName_1 = spelParser.parseExpression("members[2].inventions[1]").getValue(societyContext,
				String.class);
	...
	public void inlineListSpelTest() {
		...
		// definir y obtener el valor de una expresion que corresponda a la
		// definicion de una lista de enteros del 1 al 4
		...
		// definir y obtener el valor de una expresion que corresponda a
		// la definicion de una lista de listas de strings
		
		List<List<String>> listOfListOfStrings = spelParser.parseExpression("{ { 'a', 'b' }, { 'c', 'd' } }").getValue(List.class);
	...
	public void mapSpelTest() {
		...
		// definir y obtener el inventor 'presidente' del mapa 'oficiales' del contexto
		// society
		...
		String presidentBornCity = spelParser.parseExpression("officers['president'].placeOfBirth.city").getValue(societyContext, String.class);
		...
		// definir y obtener el nombre de la ciudad de nacimiento del inventor
		// 'presidente' del mapa 'oficiales' del contexto society
		String newPresidentBornCity = spelParser.parseExpression("officers['president'].placeOfBirth.city").getValue(societyContext, String.class); 
	...
	public void inlineMapSpelTest() {
		...
		Map<String, String> mapOfValues = (Map<String, String>) spelParser
				.parseExpression("{name:'Nikola Tesla', bornDate: '09/07/1856'}").getValue(); // solo analizar
		...
		String nikolaName = (String) spelParser.parseExpression("['name']").getValue(mapOfValues); // solo analizar
	...
	public void arrayConstructionSpelTest() {
		...
		int[] emptyIntArray = (int[]) spelParser.parseExpression("new int[4]").getValue(); // solo analizar
		...
		int[] intArray = (int[]) spelParser.parseExpression("new int[]{1,2,3,4,5}").getValue(); // solo analizar
