package com.truper.spring.core.practica20.test.resources.utils;
...
import com.truper.spring.core.practica20.test.resources.api.IInputStreamResourceReader;
...
public class ResourcesTestUtils {
	...
	public static void loadPropertiesFile(Resource resource) {
		...
		String expectedText = "truper.curso=Spring Framework 5\n" +
				"truper.instructor=Ivan Garcia";
		...
		Assert.assertEquals("Ivan Garcia", properties.getProperty("truper.instructor"));

		log.info("truper.instructor: {}", properties.getProperty("truper.instructor"));
	}
