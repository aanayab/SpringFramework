package com.truper.spring.core.practica21.test.spel.model.stub;
...
import com.truper.spring.core.practica21.spel.model.Society;

public class SocietyStub {

	public static Society createSociety(String name) { // name = IEEE
