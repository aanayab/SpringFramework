package com.truper.spring.core.practica5.scopes.custom.bean;
...
public class CustomScope implements Scope {
	...
	@Override // solo cuando sean beans de scope = "customscope"
	public Object get(String name, ObjectFactory<?> objectFactory) {

		// System.out.println("solicitando bean: " + name);
		log.info("solicitando bean: {}", name); // name => personaCustomScopeBean
		...
		if (!objectMap.containsKey(name)) {
			...
			objectMap.put(name, o); // key => personaCustomScopeBean, value => Objeto Persona
		}
