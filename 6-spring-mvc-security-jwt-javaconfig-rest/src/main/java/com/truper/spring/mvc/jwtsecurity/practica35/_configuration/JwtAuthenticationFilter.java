...
public class JwtAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	public JwtAuthenticationFilter(String loginUrl, AuthenticationManager authenticationManager) {
		super(new AntPathRequestMatcher(loginUrl)); // /api/authenticate
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
		...
		// form/www-url-encoded <= esto ocurre cuando mandamos el login por formulario (pero entra el UsernamePasswordAuthenticationFilter)
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
		...
		// No ocupo el filterChain ya que no lo debo dejar continuar hacia el backend, por que este filtro
		// authentica, genera el JWT token y lo responde...
